  ...
  async function handleComplete(e: React.FormEvent) {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'Ocurrió un error al completar la sesión',
      });
    } finally {
      setSaving(false);
    }
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <form onSubmit={handleComplete} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Resumen AI (Opcional)</CardTitle>
              <CardDescription>
                Resumen generado por IA o notas adicionales
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
                ...
                placeholder="Resumen adicional o generado por IA..."
                rows={3}
                disabled={saving}
              />
            </CardContent>
